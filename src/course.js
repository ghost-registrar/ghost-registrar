...
export class Period {
    ...
    conflicts(period) {
        ...
        if (parseInt(this.start) < parseInt(period.start)) return (parseInt(this.end) >= parseInt(period.start));
        else if (parseInt(this.start) > parseInt(period.start)) return (parseInt(period.end) >= parseInt(this.start));
        else return true;
    };
}
